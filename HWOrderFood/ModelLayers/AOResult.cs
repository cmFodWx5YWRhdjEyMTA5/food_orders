...
namespace HWOrderFood.ModelLayers
{
    /// <summary>
    ...
    public class AOResult
    {
        ...
        public AOResult(bool trackingResult = true, [CallerMemberNameAttribute]string callerName = null,
    ...
    {
        public AOResult(bool trackingResult = true,
                        [CallerMemberNameAttribute]string callerName = null,
                        [CallerFilePath]string callerFile = null,
                        [CallerLineNumber]int callerLineNumber = 0) : base(trackingResult, callerName, callerFile, callerLineNumber)
        {
